...
- (void)onlyReloadWithNewTitles:(NSArray<NSString *> *)newTitles WithSelectedIndex:(NSInteger)index{
    self.titlesArray = nil;
    self.titlesArray = newTitles.copy;
    
    [self.segmentView reloadTitlesWithNewTitles:newTitles WithSelectedIndex:index];
}
